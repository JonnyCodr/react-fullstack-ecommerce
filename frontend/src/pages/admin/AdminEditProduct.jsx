...
import {Alert, CloseButton, Form, Image, Table} from "react-bootstrap";
        ...
        <Col md={6}>
          ...
          <Form noValidate validated={validated} onSubmit={handleSubmit}>
            ...
            <Form.Group className='mb-3' controlId='formBasicDescription'>
              ...
              <Form.Control name='description' required as='textarea' rows={3} defaultValue='default description'/>
            </Form.Group>
            ...
            <Form.Group className='mb-3' controlId='formBasicPrice'>
              ...
              <Form.Control name='price' required type='text' defaultValue='999'/>
            </Form.Group>
